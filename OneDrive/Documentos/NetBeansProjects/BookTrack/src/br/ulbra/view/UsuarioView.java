...
public class UsuarioView extends javax.swing.JFrame {
    ...
    private void atualizarTabela() {
        try {
            ...
            for (Usuario u : lista) {
                modelTbl.addRow(new Object[]{u.getId(), u.getNome()});
            }
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        tbUsuario.setBackground(new java.awt.Color(204, 204, 204));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 534, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(200, 200, 200))))
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            Usuario u = new Usuario(0, nome, senha);
            controller.salvar(u);
